  ...
  return (
    <section className='header'>
      <nav className="navbar">
        <img src='/img/banner/logo.webp' className="logo" alt='Logo Galidé' />
        ...
        <ul className={`menu ${showMenu ? 'show' : ''}`}>
          ...
          <li className="menu-item">
            <Link to="quienesSomos" spy={true} smooth={true} offset={-70} duration={500}>Nosotros</Link>
          </li>
          <li className="menu-item">
            <Link to="contacto" spy={true} smooth={true} offset={-70} duration={500}>Contacto</Link>
          </li>
          <li className="menu-item">
      ...
      <div className='container'>
        <div>
          ...
          <div className='buttonContainer'>
            <a
              href="https://api.whatsapp.com/send?phone=+541143993437&text=Hola, estoy interesado en contratar sus servicios."
              target='_blank'
              rel="noreferrer noopener"
            >
              <button className='boton boton-latido'>AHORA</button>
            </a>
          </div>
